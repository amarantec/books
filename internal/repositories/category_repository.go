...
func (r *RepositoryPostgres) InsertCategory(ctx context.Context, category models.Category) (models.Category, error) {
	err := r.Conn.QueryRow(
		ctx,
		`INSERT INTO categories (name, url) VALUES ($1, $2) RETURNING id;`, category.Name, category.Url).Scan(&category.Id)
	if err != nil {
...
func (r *RepositoryPostgres) ListCategories(ctx context.Context) ([]models.Category, error) {
